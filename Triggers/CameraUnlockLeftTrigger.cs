...
{
    class CameraUnlockLeftTrigger : ICollidableObject, ITrigger
    {
        public WorldUtil.WorldState CollideDuringLesserState { get; set; }
        public CameraUnlockLeftTrigger(int height, Vector2 pos)
        {
            Position = pos;
        ...
        {
            Game1.GetLevel().GetCamera().LockedLeft = false;
        }
